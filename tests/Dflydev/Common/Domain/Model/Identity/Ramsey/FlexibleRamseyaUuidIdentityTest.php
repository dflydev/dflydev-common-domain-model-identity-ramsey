...
use Dflydev\Common\Domain\Model\Identity\Ramsey\TestImpl\FlexibleRamseyUuidIdentity;

class FlexibleRamseyaUuidIdentityTest extends AbstractUuidIdTest
{
    /**
     * @test
    ...
    {
        return FlexibleRamseyUuidIdentity::class;
    }
}
