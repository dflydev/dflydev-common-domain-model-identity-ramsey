...
use Dflydev\Common\Domain\Model\Identity\Ramsey\TestImpl\StrictRamseyUuidIdentity;
use InvalidArgumentException;

class StrictRamseyUuidIdentityTest extends AbstractUuidIdTest
{
    /** @test */
    ...
    {
        return StrictRamseyUuidIdentity::class;
    }
}
